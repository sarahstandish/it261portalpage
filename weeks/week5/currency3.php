    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($_POST['name'],
            ...
            && $_POST['bank'] != 'NULL') {
                ...
                echo "<p>Hello, $name.<br>The most recent exchange rate available to convert $currency_type to USD is $currency_rate.<br>You have $$total USD which will be transferred to $bank.<br>You will receive a confirmation email at <a href='mailto:$email'>$email</a>.</p>";
            }
    }
?>
    </div>
